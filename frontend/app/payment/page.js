...
const PaymentModal = ({
  ...
  const fetchMobileNumbers = async () => {
    try {
      const response = await axios.get(
        "http://ec2-13-232-147-76.ap-south-1.compute.amazonaws.com:5000/api/customer/mobile-numbers"
      );
  ...
  //     const customerResponse = await axios.get(`http://ec2-13-232-147-76.ap-south-1.compute.amazonaws.com:5000/api/customer/get-customer-by-mobile/${formData.mobileNumber}`);
  ...
  //         await axios.patch(`http://ec2-13-232-147-76.ap-south-1.compute.amazonaws.com:5000/api/customer/update-credit-balance/${existingCustomer._id}`, {
  ...
  //     const response = await axios.patch(`http://ec2-13-232-147-76.ap-south-1.compute.amazonaws.com:5000/api/order/update-order-by-id/${orderID}`, {
  //       ...formData,
  //       orderID,
  //       orderNumber,
  ...
  //   // Add a new customer
  //   const newCustomerResponse = await axios.post('http://ec2-13-232-147-76.ap-south-1.compute.amazonaws.com:5000/api/customer/customer/list/add-customer', {
  //     customerName: formData.customerName,
  //     mobileNumber: formData.mobileNumber,
    ...
    try {
      ...
      if (formData.mobileNumber) {
        const customerResponse = await axios.get(
          `http://ec2-13-232-147-76.ap-south-1.compute.amazonaws.com:5000/api/customer/get-customer-by-mobile/${formData.mobileNumber}`
        );
        existingCustomer = customerResponse.data;
      }
      ...
      if (formData.mobileNumber && parseFloat(formData.dueAmount) > 0) {
        ...
        if (updatedCreditBalance > 0) {
          await axios.patch(
            `http://ec2-13-232-147-76.ap-south-1.compute.amazonaws.com:5000/api/customer/update-credit-balance/${existingCustomer._id}`,
            {
              creditBalance: updatedCreditBalance,
            }
          );
      ...
      const response = await axios.patch(
        `http://ec2-13-232-147-76.ap-south-1.compute.amazonaws.com:5000/api/order/update-order-by-id/${orderID}`,
        {
          ...formData,
          orderID,
          orderNumber,
  ...
  const addNewCustomer = async () => {
    ...
    const newCustomerResponse = await axios.post(
      "http://ec2-13-232-147-76.ap-south-1.compute.amazonaws.com:5000/api/customer/customer/list/add-customer",
      {
        customerName: formData.customerName,
        mobileNumber: formData.mobileNumber,
        creditBalance: parseFloat(formData.dueAmount),
  ...
  const fetchCustomerDetails = async (mobileNumber) => {
    try {
      const response = await axios.get(
        `http://ec2-13-232-147-76.ap-south-1.compute.amazonaws.com:5000/api/customer/get-customer-by-mobile/${mobileNumber}`
      );
