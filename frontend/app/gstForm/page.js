...
const GSTForm = () => {
  ...
  const handleConfirmDelete = async () => {
    try {
      ...
      await axios.delete(`http://ec2-13-232-147-76.ap-south-1.compute.amazonaws.com:5000/api/gst/gst/${deletingItemId}`);
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await axios.post('http://ec2-13-232-147-76.ap-south-1.compute.amazonaws.com:5000/api/gst/create', { gstPercentage });
      fetchGSTList();
      setGSTPercentage('');
    } catch (error) {
